...
exports.AccuraciesService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let AccuraciesService = class AccuraciesService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    update(id, updateAccuracyDto) {
        return `This action updates a #${id} accuracy`;
    }
    remove(id) {
        return this.prisma.accuracy.delete({ where: { accuracy_id: id } });
    }
};
AccuraciesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], AccuraciesService);
exports.AccuraciesService = AccuraciesService;
//# sourceMappingURL=accuracies.service.js.map